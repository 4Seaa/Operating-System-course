...
struct seg_table_t {
	...
	} table[1 << PAGE_LEN];//Tổng số lượng segment index khác nhau là 2^5 -> do đó segment table cũng có 2^5 phần tử (trong đề có ghi là 5 bits để thể hiện segment index)
